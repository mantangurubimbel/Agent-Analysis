...
async function signInWithGoogle(forceSelect: boolean = false) {
  "use server";
...
// Server action wrapper — Next.js butuh ini
...
export default async function LoginPage({
  ...
  const errorMessage =
    params.error === "user_not_registered"
      ? "Email kamu belum terdaftar. Hubungi admin untuk didaftarkan."
      : params.error
